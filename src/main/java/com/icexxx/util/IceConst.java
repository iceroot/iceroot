...
public class IceConst {
	...
	public static final String MYSQL_DRIVER = "com.mysql.jdbc.Driver";//mysql jdbc驱动类名
	public static final String MYSQL_DRIVER_OLD = "org.gjt.mm.mysql.Driver";//mysql jdbc驱动类名(旧版本)
	public static final String ORACLE_DRIVER = "oracle.jdbc.driver.OracleDriver";//oracle jdbc驱动类名
